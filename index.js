...
utils.generateHelp = function x() {
    client.knownCommands = ["8ball", "copypasta", "dadjoke", "donger", "everyone", "fill", "%", "ping", "prefix", "pyramid", "russianroulette", "title", "tts", "uptime", "weather", "yourmom", "notify", "help", "subemotes", "uid", "steam", "cat", "dog", "channels", "geoip", "query", "botinfo", "firstmsg", "randmsg", "chatters", "mostsent", "findmsg", "emote", "avatar", "stalk", "math", "stats", "funfact", "suggest"]
    utils.helpJson = []
