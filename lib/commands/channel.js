    ...
    async execute(client, msg, utils) {
        ...
        if (option === 'join') {
            ...
            if (!data[0].entries) {
                ...
                await client.say(channelName, `Successfully joined, if you have any questions use the "${process.env.default_prefix}suggest" command followed by your question/suggestion | Command list: ${process.env.website_url}/commands BroBalt`)
