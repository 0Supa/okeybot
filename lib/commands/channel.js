            ...
            case "join": {
                ...
                if (!data[0].entries) {
                    ...
                    try {
                        ...
                        await client.say(user.login, `Successfully joined, if you have any questions use "${process.env.default_prefix}suggest" followed by your question/suggestion | Type "${process.env.default_prefix}help" for the command list BroBalt`)
                    } catch (e) {
                        console.error(e)
