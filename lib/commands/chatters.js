...
module.exports = {
    ...
    async execute(client, msg, utils) {
        ...
        return { text: `${chatters.count} chatters (${chatters.moderators.length} Moderators, ${chatters.vips.length} VIPs): ${await paste(JSON.stringify(chatters, null, 4))}`, reply: true }
    },
};
