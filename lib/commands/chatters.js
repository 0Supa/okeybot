...
module.exports = {
    ...
    async execute(client, msg, utils) {
        ...
        return { text: `there are currently ${c.chatter_count} chatters in ${user === msg.channelName ? 'this' : 'that'} channel ( ${c.chatters.vips.length} VIPs, ${c.chatters.moderators.length} MODS )`, reply: true }
    },
};