...
module.exports = {
    ...
    async execute(client, msg, utils) {
        ...
        return { text: `[${foundMessagesLength}/${messageCount} messages matched] ${foundMessagesLength > 5000 ? "first 5000 matched messages: " : ""}https://paste.ivr.fi/raw/${paste.key}`, reply: true }
    },
};