...
module.exports = {
    ...
    async execute(client, msg, utils) {
        ...
        return { text: `[${foundMessagesLength}/${messageCount} messages found] https://paste.ivr.fi/raw/${paste.key}${foundMessagesLength > 5000 ? " (only first 5000 found messages)" : ""}`, reply: true }
    },
};