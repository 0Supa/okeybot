...
module.exports = {
    ...
    async execute(client, msg, utils) {
        ...
        if (msg.commandName === 'addbot') {
            ...
            client.say(process.env.botusername, `@${process.env.owner_login} new bot request (ID: ${id}) peepoDetective 👉 https://hastebin.com/${paste.key}`)
        }
        else {
