...
module.exports = {
    ...
    async execute(client, msg, utils) {
        ...
        if (msg.commandName === 'addbot') {
            ...
            const mods = await client.getMods(user.login)
            const vips = await client.getVips(user.login)
