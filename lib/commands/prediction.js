...
module.exports = {
    ...
    async execute(client, msg, utils) {
        ...
        const res = data.createPredictionEvent
        if (!res) return { text: `failed creating prediction (internal error)`, reply: true }
        ...
        predictionTracker.add(res.predictionEvent.id)
    },
};
