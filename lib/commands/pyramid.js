module.exports = {
    ...
    async execute(client, msg, utils) {
        ...
        if (msg.args.length < 2) return { text: `invalid usage, valid: ${msg.prefix}pyramid 5 TriHard`, reply: true, error: true }
        if (isNaN(size)) return { text: `size should be a number`, reply: true, error: true }
