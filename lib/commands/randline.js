module.exports = {
    ...
    async execute(client, msg, utils) {
        ...
        const query = await utils.query(`SELECT message, timestamp, user_login FROM messages WHERE channel_id=? AND user_login=? ORDER BY RAND() LIMIT 1`, [msg.channel.id, user])
