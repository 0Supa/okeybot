...
module.exports = {
    ...
    async execute(client, msg, utils) {
        ...
        return { text: `[${data.emoteid.startsWith('emotesv2_') ? "V2" : "V1"}]: ${data.emotecode} | ${data.channel ? `${data.channel} Tier ${data.tier || "N/A"} Sub Emote` : "Global Emote"}, setid: ${data.setid} | ${data.emoteurl_3x}`, reply: true }
    },
};