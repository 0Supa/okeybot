...
module.exports = {
    ...
    async execute(client, msg, utils) {
        ...
        return { text: `${data.emoteid ? `${data.emoteid} - ` : ''}${data.emotecode} | ${data.channel ? `${data.channel} tier ${data.tier} emote` : "Global Emote"}, setid: ${data.setid} | ${data.emoteurl_3x}`, reply: true }
    },
};