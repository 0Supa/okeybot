...
module.exports = {
    ...
    async execute(client, msg, utils) {
        ...
        return { text: `https://www.epicgames.com/store/p/${encodeURIComponent(gameData.productSlug)} | Price: ${discountPrice === "0" ? "Free" : discountPrice}${discountPrice !== originalPrice ? ` [🏷️ Discount from ${originalPrice}]` : ""}`, reply: true }
    },
};
