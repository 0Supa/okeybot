...
module.exports = {
    ...
    async execute(client, msg, utils) {
        ...
        const discountPrice = game.price.fmtPrice.discountPrice
        const originalPrice = game.price.fmtPrice.originalPrice
        return { text: `https://www.epicgames.com/store/p/${encodeURIComponent(game.productSlug)} | Price: ${discountPrice === "0" ? "Free" : discountPrice}${discountPrice !== originalPrice ? " [🏷️ Discount]" : ""}`, reply: true }
    },
};
