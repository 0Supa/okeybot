...
module.exports = {
    ...
    async execute(client, msg, utils) {
        ...
        const discountPrice = gameData.price.fmtPrice.discountPrice
        const originalPrice = gameData.price.fmtPrice.originalPrice
        return { text: `https://www.epicgames.com/store/p/${encodeURIComponent(gameData.productSlug)} | Price: ${discountPrice === "0" ? "Free" : discountPrice}${discountPrice !== originalPrice ? " [🏷️ Discount]" : ""}`, reply: true }
    },
};
