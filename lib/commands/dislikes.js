...
module.exports = {
    ...
    async execute(client, msg, utils) {
        ...
        const { body: data, statusCode } = await got(`https://return-youtube-dislike-api.azurewebsites.net/votes?videoId=${encodeURIComponent(msg.args[0])}`, {
            responseType: 'json'
        })
        ...
        return { text: `👍Likes: ${data.likes} || 👎Dislikes: ${data.dislikes} || 👁View Count: ${data.viewCount}`, reply: true }
    },
};