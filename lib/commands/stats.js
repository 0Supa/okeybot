...
module.exports = {
    ...
    async execute(client, msg, utils) {
        ...
        return { text: `the bot was added on ${date.toDateString()}, logged messages: ${utils.formatNumber(messages[0].entries)}, the most active chatter is ${mostActive[0].user_login} with ${utils.formatNumber(mostActive[0].message_count)} messages sent, messages per minute: ${MPM[0].entries}`, reply: true }
    },
};