...
module.exports = {
    name: 'botsubs',
    aliases: ['emotesets'],
    description: 'All the sub emotes from Twitch channels where the bot is subscribed',
    cooldown: 5,
    async execute(client, msg, utils) {
        const emoteSets = client.userStateTracker.globalState.emoteSetsRaw.slice(12)
        if (!emoteSets) return { text: 'the bot is not subscribed to any channels FeelsBadMan', reply: true }
