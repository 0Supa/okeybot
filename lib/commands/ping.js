...
module.exports = {
    ...
    async execute(client, msg, utils) {
        ...
        const dbUptime = (utils.query(`SELECT variable_value FROM information_schema.global_status WHERE variable_name='Uptime'`))[0].variable_value
        const dbQueries = (utils.query(`SELECT variable_value FROM information_schema.global_status WHERE variable_name = 'Questions'`))[0].variable_value
