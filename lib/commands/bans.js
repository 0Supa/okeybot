...
module.exports = {
    ...
    async execute(client, msg, utils) {
        ...
        if (banData.notFound) return { text: `user is not tracked by StreamerBans${user.banned ? ", but I can tell that this user is banned" : ", but I can tell that this user is not banned"}`, reply: true }
