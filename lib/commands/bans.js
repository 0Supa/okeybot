...
module.exports = {
    ...
    async execute(client, msg, utils) {
        ...
        return { text: `tracked since ${new Date(userData.created_at).toLocaleDateString()}. Total Bans: ${userData.bans.length}, Last Ban: ${utils.humanize(lastBan)} ago, Longest Ban: ${utils.humanize(longestBan, true)}`, reply: true }
    },
};