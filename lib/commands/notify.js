module.exports = {
    ...
    async execute(client, msg, utils) {
        ...
        if (!notifyData[0].query) return { text: `this channel dosen't have notifications enabled, contact ${process.env.owner_login} if you want this feature in your channel`, reply: true }
