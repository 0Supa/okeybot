module.exports = {
    ...
    async execute(client, msg, utils) {
        ...
        if (!notifyData[0].query) return { text: `this feature is disabled by default, use the ${msg.prefix}suggest command or contact @${process.env.owner_login} if you want this feature enabled in your channel`, reply: true }
