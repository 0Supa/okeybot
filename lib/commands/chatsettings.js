...
module.exports = {
    ...
    async execute(client, msg, utils) {
        ...
        | Account Verification -> Email Verification: ${verification.emailVerificationMode !== 'NONE' ? `${verification.emailVerificationMode}: Restrict Account Age: ${emailConfig.shouldRestrictBasedOnAccountAge ? `true (${utils.humanizeMS(emailConfig.minimumAccountAgeInMinutes * 60000)})` : "false"}` : verification.emailVerificationMode}`,
            reply: true
        }
    },
};