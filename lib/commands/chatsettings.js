...
Chat Settings:
  ...
  Followers Only: ${settings.followersOnlyDurationMinutes !== null ? utils.humanizeMS(settings.followersOnlyDurationMinutes * 60000) : "false"}
  Slow Mode: ${settings.slowModeDurationSeconds ? utils.humanizeMS(settings.slowModeDurationSeconds * 1000) : "false"}

Account Verification:
  Email Verification ${verification.emailVerificationMode}:
  ...
  Phone Verification ${verification.phoneVerificationMode}:
