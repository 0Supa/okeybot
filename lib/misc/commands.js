...
const categorizedCommands = {
    ...
    "utility": ['title', 'tts', 'weather', 'notify', 'user', 'steam', 'epicgames', 'howlongtobeat', 'geoip', 'query', 'chatters', 'findmsg', 'esearch', 'avatar', 'math', 'stats', '7tvupdates', 'emote', 'lasttweet', 'tenor', 'confusables', 'transform', 'spam', 'clear', 'game', 'split', 'chatsettings', 'song', 'recently-played', 'searchsong', 'top-artists', 'top-tracks'],
}
