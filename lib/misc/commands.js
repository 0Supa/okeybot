...
const categorizedCommands = {
    Fun: ['%', '8ball', 'animal', 'copypasta', 'dadjoke', 'donger', 'funfact', 'hug', 'yourmom'],
    Twitch: ['user', 'avatar', 'emote', 'esearch', 'everyone', 'history', 'randclip', 'boobatv', 'streaminfo', 'chatsettings'],
    Lines: ['clear', 'fill', 'spam', 'split', 'pyramid', 'findmsg', 'firstmsg', 'lines', 'mostsent', 'randline', 'stalk'],
    Utils: ['confusables', 'transform', 'geoip', 'math', 'query', 'tts', 'weather'],
    Apps: ['google', 'dislikes', 'steam', 'epicgames', 'howlongtobeat', 'lasttweet', 'twitter', 'tenor', 'uberduck'],
    Spotify: ['recentlyplayed', 'searchsong', 'song', 'topartists', 'toptracks'],
    Bot: ['botinfo', 'botsubs', 'help', 'prefix', 'mode', 'cmd', 'pajbot', 'ping', 'stats', 'suggest'],
}
