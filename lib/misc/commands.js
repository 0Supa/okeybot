...
const categorizedCommands = {
    ...
    "utility": ['title', 'uptime', 'tts', 'weather', 'notify', 'user', 'steam', 'geoip', 'query', 'chatters', 'findmsg', 'esearch', 'avatar', 'math', 'stats', '7tvupdates', 'emote', 'epicgames', 'tenor', 'confusables', 'transform', 'spam', 'clear', 'game', 'nuke', 'pardon', 'split', 'chatsettings', 'song', 'recently-played', 'searchsong'],
}
