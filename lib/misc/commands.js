...
const categorizedCommands = {
    ...
    "utility": ['title', 'weather', 'notify', 'user', 'steam', 'epicgames', 'howlongtobeat', 'dislikes', 'geoip', 'query', 'chatters', 'findmsg', 'esearch', 'avatar', 'math', 'stats', '7tvupdates', 'emote', 'lasttweet', 'tenor', 'confusables', 'transform', 'spam', 'clear', 'game', 'split', 'chatsettings', 'song', 'recently-played', 'searchsong', 'top-artists', 'top-tracks'],
}
