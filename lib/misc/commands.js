...
const categorizedCommands = {
    "fun": ['8ball', 'copypasta', 'tts', 'uberduck', 'dadjoke', 'donger', 'fill', '%', 'pyramid', 'yourmom', 'animal', 'firstmsg', 'randline', 'randclip', 'mostsent', 'stalk', 'funfact', 'lines', 'everyone', 'hug'],
    "bot": ['ping', 'prefix', 'pajbot', 'help', 'botsubs', 'botinfo', 'suggest', 'cmd'],
    "utility": ['weather', 'notify', 'user', 'streaminfo', 'history', 'steam', 'epicgames', 'howlongtobeat', 'dislikes', 'geoip', 'query', 'chatters', 'findmsg', 'esearch', 'avatar', 'math', 'stats', '7tvupdates', 'twitter', 'emote', 'lasttweet', 'tenor', 'confusables', 'transform', 'spam', 'clear', 'split', 'chatsettings', 'song', 'recently-played', 'searchsong', 'top-artists', 'top-tracks'],
}
