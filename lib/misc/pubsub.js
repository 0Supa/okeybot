...
const handleWSMsg = async (msg = {}) => {
    ...
    switch (msg.type) {
        ...
        case 'reward-redeemed': {
            ...
            const data = await utils.query('SELECT channel_login, app_userid, emote_id, reward_title FROM emotes WHERE channel_id=? AND reward_title=?', [redemption.channel_id, redemption.reward.title])
