...
const handleWSMsg = async (msg = {}) => {
    ...
    switch (msg.type) {
        ...
        case 'reward-redeemed': {
            ...
            if (!data.length || data[0].reward_title !== redemption.reward.title) return console.log('xd');
            ...
            const removedEmote = await emotes.BTTVemote('remove', data[0].emote_id, redemption.channel_id).catch(err => {
